...
const navItems: NavItem[] = [
  ...
  { path: '/time-log', label: 'Timesheet', icon: <Clock className="w-[18px] h-[18px]" /> },
              ...
              return (
                <React.Fragment key={item.path}>
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-3 rounded-[8px] transition-all duration-200 mb-0.5 ${collapsed ? 'px-3 py-2.5 justify-center' : 'px-3 py-2.5'
