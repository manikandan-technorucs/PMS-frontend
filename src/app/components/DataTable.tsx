          ...
          <thead>
            <tr className="border-b border-[#E5E7EB] bg-[#F8FAFC]">
              ...
              {columns.map((column) => (
                <th
                  key={column.key}
                  className="px-4 py-3 text-left text-[14px] font-semibold text-[#1F2937]"
                >
            ...
            {paginatedData.map((row, rowIndex) => {
              ...
              return (
                <tr
                  ...
                  className={`border-b border-[#E5E7EB] hover:bg-[#F8FAFC] transition-colors h-12 ${
                ...
                >
                  ...
                  {columns.map((column) => (
                    <td key={column.key} className="px-4 py-3 text-[14px] text-[#1F2937]">
