                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-start justify-between gap-3">
                                                    <div className="min-w-0">
                                                        ...
                                                        <p className="notification-message mt-1 line-clamp-2">{notification.message}</p>
                                                    </div>
                                                    <div className="flex items-center gap-2 flex-shrink-0">
                                                        <span className="notification-time whitespace-nowrap">{notification.time}</span>
                                                        <button
                                                            className="header-icon-btn p-1.5 opacity-0 group-hover:opacity-100"
