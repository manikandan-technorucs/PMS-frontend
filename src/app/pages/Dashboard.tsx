            ...
            <Card key={index} className="p-4">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <p className="text-[12px] text-[#6B7280] mb-1">{kpi.title}</p>
                  <p className="text-[24px] font-semibold text-[#1F2937] mb-1">{kpi.value}</p>
                  <div className="flex items-center gap-1">
                    ...
                    <span className={`text-[12px] ${kpi.trend === 'up' ? 'text-[#16A34A]' : 'text-[#DC2626]'}`}>
                      {kpi.change}
                    </span>
                  </div>
                </div>
