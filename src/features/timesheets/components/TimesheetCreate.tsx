          ...
          <div className="md:col-span-2 lg:col-span-3">
            ...
            <div className="border border-theme-border rounded-lg p-4 bg-theme-neutralShadow">
              ...
              <div className="flex items-center justify-between bg-theme-surface border border-theme-border rounded-lg px-4 py-3 shadow-sm">
                <Button unstyled type="button" onClick={() => navigate_date('prev')} className="p-1 hover:bg-theme-neutral rounded transition-colors">
                ...
                <Button unstyled type="button" onClick={() => navigate_date('next')} className="p-1 hover:bg-theme-neutral rounded transition-colors">
