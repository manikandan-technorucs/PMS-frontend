      ...
      <form onSubmit={handleSubmit} className="max-w-[1200px] mx-auto">
        ...
        <FormCard columns={3} footer={{ onCancel: () => navigate('/timesheets'), submitLabel: 'Update Timesheet', submittingLabel: 'Updating...', isSubmitting, isDisabled: !selectedUserId || !selectedProjectId }}>
          ...
          <div className="md:col-span-2 lg:col-span-3">
            <label className="text-[13px] font-semibold text-slate-700 dark:text-gray-300 block mb-2">Time Period <span className="text-red-500">*</span></label>
            <div className="border rounded-lg p-4 bg-gray-50 dark:bg-slate-800/50">
              ...
              <div className="flex items-center justify-between bg-white dark:bg-slate-700 border rounded-lg px-4 py-3 shadow-sm">
                <button type="button" onClick={() => navigate_date('prev')} className="p-1 hover:bg-gray-100 dark:hover:bg-slate-600 rounded transition-colors"><ChevronLeft className="w-5 h-5 text-gray-500" /></button>
                ...
                <button type="button" onClick={() => navigate_date('next')} className="p-1 hover:bg-gray-100 dark:hover:bg-slate-600 rounded transition-colors"><ChevronRight className="w-5 h-5 text-gray-500" /></button>
              </div>
            </div>
          </div>
