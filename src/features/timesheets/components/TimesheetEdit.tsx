          ...
          <div className="md:col-span-2 lg:col-span-3">
            ...
            <div className="border border-theme-border rounded-lg p-4 bg-theme-neutralShadow">
              <div className="flex justify-center mb-4">
                <div className="flex bg-theme-surface border border-theme-border rounded-lg p-1 shadow-sm">
                  {(['day', 'week', 'month'] as const).map(mode => (
                    <Button unstyled key={mode} type="button" onClick={() => setViewMode(mode)}
              ...
              <div className="flex items-center justify-between bg-theme-surface border border-theme-border rounded-lg px-4 py-3 shadow-sm">
                <Button unstyled type="button" onClick={() => navigate_date('prev')} className="p-1 hover:bg-theme-neutral rounded transition-colors"><ChevronLeft className="w-5 h-5 text-theme-muted" /></Button>
                ...
                <Button unstyled type="button" onClick={() => navigate_date('next')} className="p-1 hover:bg-theme-neutral rounded transition-colors"><ChevronRight className="w-5 h-5 text-theme-muted" /></Button>
              </div>
            </div>
          </div>
