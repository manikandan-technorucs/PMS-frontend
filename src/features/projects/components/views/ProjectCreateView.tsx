/**
 * ProjectCreateView — 3-step PrimeReact Stepper wizard.
 *
 * Step 1: Project Details    (required domain fields + optional metadata)
 * Step 2: Template Selection (select from ProjectTemplate or start blank)
 * Step 3: Member Assignment  (PM, Delivery Head, team members)
 *
 * Form state is managed by react-hook-form across all steps.
 * Each "Next" click triggers step-scoped validation via trigger([...fields]).
 */
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Stepper ref={stepperRef} linear style={{ '--p-stepper-active-color': 'hsl(160 60% 45%)' } as any}>
                        ...
                        <StepperPanel header="Template">
                            ...
                            {/* Task preview for selected template */}
                            {selectedTemplate && (
