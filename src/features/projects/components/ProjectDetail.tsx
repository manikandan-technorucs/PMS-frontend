              ...
              <div className="grid md:grid-cols-2 gap-5">
                <GlassCard>
                  <div className="p-4 border-b border-slate-200/50 dark:border-slate-800/50 flex items-center justify-between">
                    ...
                    <Button unstyled className="text-xs font-bold text-teal-600 hover:text-teal-700 transition-colors" onClick={() => setActiveTab('Milestones')}>View All</Button>
                  </div>
                  <div className="p-4">
                ...
                <GlassCard>
                  <div className="p-4 border-b border-slate-200/50 dark:border-slate-800/50 flex items-center justify-between">
                    ...
                    <Button unstyled className="text-xs font-bold text-teal-600 hover:text-teal-700 transition-colors" onClick={() => setActiveTab('Users')}>Manage</Button>
                  </div>
                  <div className="p-4">
