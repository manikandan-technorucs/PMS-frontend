                ...
                <aside className="w-full lg:w-[280px] border-b lg:border-b-0 lg:border-r flex flex-col flex-shrink-0" style={{ backgroundColor: 'var(--bg-primary)', borderColor: 'var(--border-color)' }}>
                    <div className="p-6 lg:p-8 pb-4 flex flex-col items-center border-b mb-4" style={{ borderColor: 'var(--border-color)' }}>
                        <div className="relative group mb-4">
                            ...
                            <button className="absolute bottom-0 right-0 w-8 h-8 border rounded-full flex items-center justify-center shadow-sm transition-colors" style={{ backgroundColor: 'var(--bg-primary)', borderColor: 'var(--border-color)' }}>
                    ...
                    <nav className="flex-1 px-3 lg:px-4 space-y-1 overflow-y-auto">
                        {profileTabs.map((tab) => (
                            ...
                            >
                                <div className={`p-2 rounded-md ${isTabActive(tab.id) ? 'bg-brand-teal-600 text-white' : 'text-theme-muted'}`} style={!isTabActive(tab.id) ? { backgroundColor: 'var(--bg-secondary)' } : {}}>
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="text-[11px] text-theme-muted truncate hidden lg:block">{tab.description}</p>
                                </div>
                    ...
                    <div className="p-3 lg:p-4 border-t" style={{ borderColor: 'var(--border-color)' }}>
                        <button
                            onClick={logout}
                            className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors text-[13px] font-medium"
                        >
                                ...
                                <div className="space-y-6">
                                    <Card className="p-0 shadow-none">
                                        <div className="p-6 border-b flex items-center justify-between" style={{ borderColor: 'var(--border-color)' }}>
                                            ...
                                            <Button variant="outline" size="sm">Change via Microsoft</Button>
                                        </div>
                        ...
                        {activeTab === 'emails' && (
                            <div className="space-y-10 animate-in fade-in duration-500">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <Button variant="outline" className="w-full h-14 border-dashed border-2 text-theme-muted hover:text-brand-teal-700 dark:hover:text-brand-teal-400 transition-all flex items-center justify-center gap-2">
