                    ...
                    {permissions.map((perm, permIndex) => (
                      <tr
                        ...
                        style={{
                          ...
                          backgroundColor: ['Projects', 'Tasks', 'Issues'].includes(module.name) ? 'var(--primary-light)' : (moduleIndex % 2 === 0 ? 'var(--card-bg)' : 'var(--bg-secondary)')
                        }}
                      ...
                      >
                        ...
                        {permIndex === 0 ? (
                          <td
                            ...
                            style={{ borderColor: 'var(--card-border)', backgroundColor: ['Projects', 'Tasks', 'Issues'].includes(module.name) ? 'var(--primary-light)' : (moduleIndex % 2 === 0 ? 'var(--card-bg)' : 'var(--bg-secondary)') }}
                          >
